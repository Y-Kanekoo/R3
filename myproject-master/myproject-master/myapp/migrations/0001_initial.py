    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('threshold_type', models.CharField(choices=[('min', 'Minimum Value'), ('max', 'Maximum Value'), ('exact', 'Exact Value')], max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.employee')),
                ('questionnaire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.questionnaire')),
            ...
            options={
                'db_table': 'thresholds',
                'constraints': [models.UniqueConstraint(fields=('employee', 'questionnaire'), name='unique_employee_questionnaire')],
            },
        ),
    ]
